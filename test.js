...
//modifique lo que se le pasa a addArtist (agregue "country:")
function createAndAddArtist(unqfy, artistName, _country) {
  unqfy.addArtist({ name: artistName, country: _country });
...
describe('Add, remove and filter data', () => {
  ...
  it('should get all tracks matching artist', () => {
    ...
    //console.log("nombre artista buscado: "+artist.name)
